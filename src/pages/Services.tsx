...
export default function Services() {
  return (
    <Layout>
      <PageMeta
        title="Engagement Models | The CTO Mentor"
        description="Strategic technology leadership tailored to your stage and challenge. CTO Advisory from $5K/mo, Embedded Leadership from $12K/mo, Technical Due Diligence from $15K."
      />
        ...
        <div className="container mx-auto px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-xl font-body text-subtle leading-relaxed">
              Strategic technology leadership tailored to your stage, your challenge, and your timeline. Every engagement starts with a conversation — not a contract.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg font-body text-subtle leading-relaxed mb-10">
              Most relationships start with a 30-minute discovery call. I'll ask about your technology challenges, your team, and your goals — and I'll tell you honestly which engagement model makes sense. Sometimes the answer is "you don't need me yet," and that's fine too.
            </p>
            <Link to="/apply">
      ...
      {/* Section 4: How engagements work */}
      <section className="bg-background">
        <div className="container mx-auto px-6 lg:px-8 py-20 lg:py-28">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {howItWorks.map((item) => (
              <div key={item.step} className="relative">
                <span className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-accent/10 text-accent mb-6">
                  <item.icon size={24} />
                </span>
        ...
        <div className="container mx-auto px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-2xl">
            ...
            <p className="text-lg font-body text-primary-foreground/90 leading-relaxed mb-10">
              Every engagement starts with a conversation. Book a free 30-minute discovery call and I'll give you an honest assessment of how I can help — or whether you need something different entirely.
            </p>
            <Link to="/apply">
              <Button
                variant="outline"
