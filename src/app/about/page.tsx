  ...
  return (
    <>
        ...
        <div className="container mx-auto px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-4xl flex flex-col md:flex-row md:items-start gap-10">
            ...
            <div className="flex-1">
              ...
              <p className="mt-2 text-sm font-body text-subtle">Product & Technology Leader · Chicago, IL</p>
      ...
      <section className="bg-background">
        <div className="container mx-auto px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-3xl space-y-6">
            <h2 className="font-heading text-2xl font-semibold text-heading">Background</h2>
      ...
      <section className="bg-section-gradient border-y border-divider">
        <div className="container mx-auto px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-3xl space-y-6">
            <h2 className="font-heading text-2xl font-semibold text-heading">My view on technology leadership</h2>
            <p className="text-base font-body text-foreground leading-relaxed">
      ...
      <section className="bg-background">
        <div className="container mx-auto px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-3xl">
            <h2 className="font-heading text-2xl font-semibold text-heading mb-6">The Bench</h2>
            <p className="text-base font-body text-foreground leading-relaxed">
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="container mx-auto px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-2xl">
            <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-6">Let's talk</h2>
